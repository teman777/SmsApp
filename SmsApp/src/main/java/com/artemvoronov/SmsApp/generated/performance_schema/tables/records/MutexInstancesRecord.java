...
public class MutexInstancesRecord extends UpdatableRecordImpl<MutexInstancesRecord> implements Record3<String, ULong, ULong> {
    ...
    public MutexInstancesRecord(String name, ULong objectInstanceBegin, ULong lockedByThreadId) {
        ...
        setLockedByThreadId(lockedByThreadId);
    }
}
