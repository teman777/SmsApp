...
public class Diagnostics extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public static final Parameter<UInteger> IN_MAX_RUNTIME = Internal.createParameter("in_max_runtime", SQLDataType.INTEGERUNSIGNED, false, false);

    /**
     * The parameter <code>sys.diagnostics.in_interval</code>.
     */
    public static final Parameter<UInteger> IN_INTERVAL = Internal.createParameter("in_interval", SQLDataType.INTEGERUNSIGNED, false, false);

    /**
     * The parameter <code>sys.diagnostics.in_auto_config</code>.
     */
    public static final Parameter<String> IN_AUTO_CONFIG = Internal.createParameter("in_auto_config", SQLDataType.VARCHAR(7), false, false);
