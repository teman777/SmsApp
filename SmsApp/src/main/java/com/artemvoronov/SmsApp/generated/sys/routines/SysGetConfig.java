...
public class SysGetConfig extends AbstractRoutine<String> {
     ...
     */
    public static final Parameter<String> IN_VARIABLE_NAME = Internal.createParameter("in_variable_name", SQLDataType.VARCHAR(128), false, false);

    /**
     * The parameter <code>sys.sys_get_config.in_default_value</code>.
     */
    public static final Parameter<String> IN_DEFAULT_VALUE = Internal.createParameter("in_default_value", SQLDataType.VARCHAR(128), false, false);

    /**
     * Create a new routine call instance
     */
    public SysGetConfig() {
        super("sys_get_config", Sys.SYS, SQLDataType.VARCHAR(128));
