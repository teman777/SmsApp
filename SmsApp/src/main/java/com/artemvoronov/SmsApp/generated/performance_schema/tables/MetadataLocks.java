...
public class MetadataLocks extends TableImpl<MetadataLocksRecord> {
     ...
     */
    public final TableField<MetadataLocksRecord, String> OBJECT_TYPE = createField(DSL.name("OBJECT_TYPE"), SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>performance_schema.metadata_locks.OBJECT_SCHEMA</code>.
     */
    public final TableField<MetadataLocksRecord, String> OBJECT_SCHEMA = createField(DSL.name("OBJECT_SCHEMA"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.metadata_locks.OBJECT_NAME</code>.
     */
    public final TableField<MetadataLocksRecord, String> OBJECT_NAME = createField(DSL.name("OBJECT_NAME"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.metadata_locks.COLUMN_NAME</code>.
     */
    public final TableField<MetadataLocksRecord, String> COLUMN_NAME = createField(DSL.name("COLUMN_NAME"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.metadata_locks.OBJECT_INSTANCE_BEGIN</code>.
     */
    public final TableField<MetadataLocksRecord, ULong> OBJECT_INSTANCE_BEGIN = createField(DSL.name("OBJECT_INSTANCE_BEGIN"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.metadata_locks.LOCK_TYPE</code>.
     */
    public final TableField<MetadataLocksRecord, String> LOCK_TYPE = createField(DSL.name("LOCK_TYPE"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>performance_schema.metadata_locks.LOCK_DURATION</code>.
     */
    public final TableField<MetadataLocksRecord, String> LOCK_DURATION = createField(DSL.name("LOCK_DURATION"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>performance_schema.metadata_locks.LOCK_STATUS</code>.
     */
    public final TableField<MetadataLocksRecord, String> LOCK_STATUS = createField(DSL.name("LOCK_STATUS"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>performance_schema.metadata_locks.SOURCE</code>.
     */
    public final TableField<MetadataLocksRecord, String> SOURCE = createField(DSL.name("SOURCE"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.metadata_locks.OWNER_THREAD_ID</code>.
     */
    public final TableField<MetadataLocksRecord, ULong> OWNER_THREAD_ID = createField(DSL.name("OWNER_THREAD_ID"), SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>performance_schema.metadata_locks.OWNER_EVENT_ID</code>.
     */
    public final TableField<MetadataLocksRecord, ULong> OWNER_EVENT_ID = createField(DSL.name("OWNER_EVENT_ID"), SQLDataType.BIGINTUNSIGNED, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.METADATA_LOCKS_OBJECT_TYPE, Indexes.METADATA_LOCKS_OWNER_THREAD_ID);
    }
