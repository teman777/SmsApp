...
import com.artemvoronov.SmsApp.generated.sys.tables.records.UserSummaryByFileIoRecord;
...
public class UserSummaryByFileIo extends TableImpl<UserSummaryByFileIoRecord> {
     ...
     */
    public final TableField<UserSummaryByFileIoRecord, String> USER = createField(DSL.name("user"), SQLDataType.VARCHAR(32), this, "");

    /**
     * The column <code>sys.user_summary_by_file_io.ios</code>.
     */
    public final TableField<UserSummaryByFileIoRecord, BigInteger> IOS = createField(DSL.name("ios"), SQLDataType.DECIMAL_INTEGER(42), this, "");

    /**
     * The column <code>sys.user_summary_by_file_io.io_latency</code>.
     */
    public final TableField<UserSummaryByFileIoRecord, String> IO_LATENCY = createField(DSL.name("io_latency"), SQLDataType.VARCHAR(11), this, "");
