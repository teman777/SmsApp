...
public class ListDrop extends AbstractRoutine<String> {
     ...
     */
    public static final Parameter<String> IN_DROP_VALUE = Internal.createParameter("in_drop_value", SQLDataType.CLOB, false, false);

    /**
     * Create a new routine call instance
     */
    public ListDrop() {
        super("list_drop", Sys.SYS, SQLDataType.CLOB);
