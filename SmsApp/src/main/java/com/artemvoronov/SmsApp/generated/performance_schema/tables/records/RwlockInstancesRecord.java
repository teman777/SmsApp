...
public class RwlockInstancesRecord extends UpdatableRecordImpl<RwlockInstancesRecord> implements Record4<String, ULong, ULong, UInteger> {
    ...
    public RwlockInstancesRecord(String name, ULong objectInstanceBegin, ULong writeLockedByThreadId, UInteger readLockedByCount) {
        ...
        setWriteLockedByThreadId(writeLockedByThreadId);
        setReadLockedByCount(readLockedByCount);
    }
}
