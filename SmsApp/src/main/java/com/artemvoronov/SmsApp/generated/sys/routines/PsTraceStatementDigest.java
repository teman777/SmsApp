...
public class PsTraceStatementDigest extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public static final Parameter<String> IN_DIGEST = Internal.createParameter("in_digest", SQLDataType.VARCHAR(64), false, false);

    /**
     * The parameter <code>sys.ps_trace_statement_digest.in_runtime</code>.
     */
    public static final Parameter<Integer> IN_RUNTIME = Internal.createParameter("in_runtime", SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>sys.ps_trace_statement_digest.in_interval</code>.
     */
    public static final Parameter<BigDecimal> IN_INTERVAL = Internal.createParameter("in_interval", SQLDataType.DECIMAL(2, 2), false, false);
     ...
     */
    public static final Parameter<Byte> IN_AUTO_ENABLE = Internal.createParameter("in_auto_enable", SQLDataType.TINYINT, false, false);
