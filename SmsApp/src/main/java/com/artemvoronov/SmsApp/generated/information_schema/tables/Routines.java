...
import com.artemvoronov.SmsApp.generated.information_schema.tables.records.RoutinesRecord;
...
public class Routines extends TableImpl<RoutinesRecord> {
     ...
     */
    public final TableField<RoutinesRecord, String> ROUTINE_CATALOG = createField(DSL.name("ROUTINE_CATALOG"), SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.ROUTINES.ROUTINE_SCHEMA</code>.
     */
    public final TableField<RoutinesRecord, String> ROUTINE_SCHEMA = createField(DSL.name("ROUTINE_SCHEMA"), SQLDataType.VARCHAR(64).nullable(false), this, "");
     ...
     */
    public final TableField<RoutinesRecord, RoutinesRoutineType> ROUTINE_TYPE = createField(DSL.name("ROUTINE_TYPE"), SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(com.artemvoronov.SmsApp.generated.information_schema.enums.RoutinesRoutineType.class), this, "");
     ...
     */
    public final TableField<RoutinesRecord, RoutinesSqlDataAccess> SQL_DATA_ACCESS = createField(DSL.name("SQL_DATA_ACCESS"), SQLDataType.VARCHAR(17).nullable(false).asEnumDataType(com.artemvoronov.SmsApp.generated.information_schema.enums.RoutinesSqlDataAccess.class), this, "");
     ...
     */
    public final TableField<RoutinesRecord, RoutinesSecurityType> SECURITY_TYPE = createField(DSL.name("SECURITY_TYPE"), SQLDataType.VARCHAR(7).nullable(false).asEnumDataType(com.artemvoronov.SmsApp.generated.information_schema.enums.RoutinesSecurityType.class), this, "");
