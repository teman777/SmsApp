...
import com.artemvoronov.SmsApp.generated.mysql.enums.SlaveRelayLogInfoAssignGtidsToAnonymousTransactionsType;
import com.artemvoronov.SmsApp.generated.mysql.enums.SlaveRelayLogInfoRequireTablePrimaryKeyCheck;
...
public class SlaveRelayLogInfo extends TableImpl<SlaveRelayLogInfoRecord> {
     ...
     */
    public final TableField<SlaveRelayLogInfoRecord, String> CHANNEL_NAME = createField(DSL.name("Channel_name"), SQLDataType.CHAR(64).nullable(false), this, "The channel on which the slave is connected to a source. Used in Multisource Replication");

    /**
     * The column <code>mysql.slave_relay_log_info.Privilege_checks_username</code>. Username part of PRIVILEGE_CHECKS_USER.
     */
    public final TableField<SlaveRelayLogInfoRecord, String> PRIVILEGE_CHECKS_USERNAME = createField(DSL.name("Privilege_checks_username"), SQLDataType.CHAR(32), this, "Username part of PRIVILEGE_CHECKS_USER.");

    /**
     * The column <code>mysql.slave_relay_log_info.Privilege_checks_hostname</code>. Hostname part of PRIVILEGE_CHECKS_USER.
     */
    public final TableField<SlaveRelayLogInfoRecord, String> PRIVILEGE_CHECKS_HOSTNAME = createField(DSL.name("Privilege_checks_hostname"), SQLDataType.CHAR(255), this, "Hostname part of PRIVILEGE_CHECKS_USER.");
     ...
     */
    public final TableField<SlaveRelayLogInfoRecord, SlaveRelayLogInfoRequireTablePrimaryKeyCheck> REQUIRE_TABLE_PRIMARY_KEY_CHECK = createField(DSL.name("Require_table_primary_key_check"), SQLDataType.VARCHAR(6).nullable(false).defaultValue(DSL.inline("STREAM", SQLDataType.VARCHAR)).asEnumDataType(com.artemvoronov.SmsApp.generated.mysql.enums.SlaveRelayLogInfoRequireTablePrimaryKeyCheck.class), this, "Indicates what is the channel policy regarding tables having primary keys on create and alter table queries");
