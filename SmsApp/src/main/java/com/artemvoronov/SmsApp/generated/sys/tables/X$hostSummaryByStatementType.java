...
import com.artemvoronov.SmsApp.generated.sys.tables.records.X$hostSummaryByStatementTypeRecord;
...
public class X$hostSummaryByStatementType extends TableImpl<X$hostSummaryByStatementTypeRecord> {
     ...
     */
    public final TableField<X$hostSummaryByStatementTypeRecord, String> HOST = createField(DSL.name("host"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>sys.x$host_summary_by_statement_type.statement</code>.
     */
    public final TableField<X$hostSummaryByStatementTypeRecord, String> STATEMENT = createField(DSL.name("statement"), SQLDataType.VARCHAR(128), this, "");

    /**
     * The column <code>sys.x$host_summary_by_statement_type.total</code>.
     */
    public final TableField<X$hostSummaryByStatementTypeRecord, ULong> TOTAL = createField(DSL.name("total"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.x$host_summary_by_statement_type.total_latency</code>.
     */
    public final TableField<X$hostSummaryByStatementTypeRecord, ULong> TOTAL_LATENCY = createField(DSL.name("total_latency"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.x$host_summary_by_statement_type.max_latency</code>.
     */
    public final TableField<X$hostSummaryByStatementTypeRecord, ULong> MAX_LATENCY = createField(DSL.name("max_latency"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.x$host_summary_by_statement_type.lock_latency</code>.
     */
    public final TableField<X$hostSummaryByStatementTypeRecord, ULong> LOCK_LATENCY = createField(DSL.name("lock_latency"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.x$host_summary_by_statement_type.rows_sent</code>.
     */
    public final TableField<X$hostSummaryByStatementTypeRecord, ULong> ROWS_SENT = createField(DSL.name("rows_sent"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.x$host_summary_by_statement_type.rows_examined</code>.
     */
    public final TableField<X$hostSummaryByStatementTypeRecord, ULong> ROWS_EXAMINED = createField(DSL.name("rows_examined"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.x$host_summary_by_statement_type.rows_affected</code>.
     */
    public final TableField<X$hostSummaryByStatementTypeRecord, ULong> ROWS_AFFECTED = createField(DSL.name("rows_affected"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.x$host_summary_by_statement_type.full_scans</code>.
     */
    public final TableField<X$hostSummaryByStatementTypeRecord, ULong> FULL_SCANS = createField(DSL.name("full_scans"), SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINTUNSIGNED)), this, "");
