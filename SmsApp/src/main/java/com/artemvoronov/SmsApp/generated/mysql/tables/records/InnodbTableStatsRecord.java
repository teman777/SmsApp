...
public class InnodbTableStatsRecord extends UpdatableRecordImpl<InnodbTableStatsRecord> implements Record6<String, String, LocalDateTime, ULong, ULong, ULong> {
    ...
    @Override
    public Row6<String, String, LocalDateTime, ULong, ULong, ULong> valuesRow() {
    ...
    @Override
    public InnodbTableStatsRecord value3(LocalDateTime value) {
        setLastUpdate(value);
        return this;
    }
    ...
    @Override
    public InnodbTableStatsRecord values(String value1, String value2, LocalDateTime value3, ULong value4, ULong value5, ULong value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
