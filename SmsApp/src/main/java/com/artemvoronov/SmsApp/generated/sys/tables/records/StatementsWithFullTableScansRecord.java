...
public class StatementsWithFullTableScansRecord extends TableRecordImpl<StatementsWithFullTableScansRecord> implements Record14<String, String, ULong, String, ULong, ULong, BigInteger, ULong, ULong, BigInteger, BigInteger, LocalDateTime, LocalDateTime, String> {
    ...
    @Override
    public Row14<String, String, ULong, String, ULong, ULong, BigInteger, ULong, ULong, BigInteger, BigInteger, LocalDateTime, LocalDateTime, String> valuesRow() {
    ...
    @Override
    public StatementsWithFullTableScansRecord value12(LocalDateTime value) {
        setFirstSeen(value);
        return this;
    }

    @Override
    public StatementsWithFullTableScansRecord value13(LocalDateTime value) {
        setLastSeen(value);
        return this;
    }
    ...
    @Override
    public StatementsWithFullTableScansRecord values(String value1, String value2, ULong value3, String value4, ULong value5, ULong value6, BigInteger value7, ULong value8, ULong value9, BigInteger value10, BigInteger value11, LocalDateTime value12, LocalDateTime value13, String value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public StatementsWithFullTableScansRecord(String query, String db, ULong execCount, String totalLatency, ULong noIndexUsedCount, ULong noGoodIndexUsedCount, BigInteger noIndexUsedPct, ULong rowsSent, ULong rowsExamined, BigInteger rowsSentAvg, BigInteger rowsExaminedAvg, LocalDateTime firstSeen, LocalDateTime lastSeen, String digest) {
        super(StatementsWithFullTableScans.STATEMENTS_WITH_FULL_TABLE_SCANS);
