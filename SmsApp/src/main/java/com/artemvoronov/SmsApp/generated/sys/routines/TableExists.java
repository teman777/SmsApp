...
public class TableExists extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public static final Parameter<String> IN_DB = Internal.createParameter("in_db", SQLDataType.VARCHAR(64), false, false);

    /**
     * The parameter <code>sys.table_exists.in_table</code>.
     */
    public static final Parameter<String> IN_TABLE = Internal.createParameter("in_table", SQLDataType.VARCHAR(64), false, false);

    /**
     * The parameter <code>sys.table_exists.out_exists</code>.
     */
    public static final Parameter<String> OUT_EXISTS = Internal.createParameter("out_exists", SQLDataType.VARCHAR(10), false, false);
