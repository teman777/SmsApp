...
import com.artemvoronov.SmsApp.generated.sys.tables.records.StatementsWithSortingRecord;
...
public class StatementsWithSorting extends TableImpl<StatementsWithSortingRecord> {
     ...
     */
    public final TableField<StatementsWithSortingRecord, String> QUERY = createField(DSL.name("query"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>sys.statements_with_sorting.db</code>.
     */
    public final TableField<StatementsWithSortingRecord, String> DB = createField(DSL.name("db"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>sys.statements_with_sorting.exec_count</code>.
     */
    public final TableField<StatementsWithSortingRecord, ULong> EXEC_COUNT = createField(DSL.name("exec_count"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.statements_with_sorting.total_latency</code>.
     */
    public final TableField<StatementsWithSortingRecord, String> TOTAL_LATENCY = createField(DSL.name("total_latency"), SQLDataType.VARCHAR(11), this, "");

    /**
     * The column <code>sys.statements_with_sorting.sort_merge_passes</code>.
     */
    public final TableField<StatementsWithSortingRecord, ULong> SORT_MERGE_PASSES = createField(DSL.name("sort_merge_passes"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.statements_with_sorting.avg_sort_merges</code>.
     */
    public final TableField<StatementsWithSortingRecord, BigInteger> AVG_SORT_MERGES = createField(DSL.name("avg_sort_merges"), SQLDataType.DECIMAL_INTEGER(21).nullable(false).defaultValue(DSL.inline("0", SQLDataType.DECIMAL_INTEGER)), this, "");

    /**
     * The column <code>sys.statements_with_sorting.sorts_using_scans</code>.
     */
    public final TableField<StatementsWithSortingRecord, ULong> SORTS_USING_SCANS = createField(DSL.name("sorts_using_scans"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.statements_with_sorting.sort_using_range</code>.
     */
    public final TableField<StatementsWithSortingRecord, ULong> SORT_USING_RANGE = createField(DSL.name("sort_using_range"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.statements_with_sorting.rows_sorted</code>.
     */
    public final TableField<StatementsWithSortingRecord, ULong> ROWS_SORTED = createField(DSL.name("rows_sorted"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.statements_with_sorting.avg_rows_sorted</code>.
     */
    public final TableField<StatementsWithSortingRecord, BigInteger> AVG_ROWS_SORTED = createField(DSL.name("avg_rows_sorted"), SQLDataType.DECIMAL_INTEGER(21).nullable(false).defaultValue(DSL.inline("0", SQLDataType.DECIMAL_INTEGER)), this, "");

    /**
     * The column <code>sys.statements_with_sorting.first_seen</code>.
     */
    public final TableField<StatementsWithSortingRecord, LocalDateTime> FIRST_SEEN = createField(DSL.name("first_seen"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.inline("0000-00-00 00:00:00.000000", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>sys.statements_with_sorting.last_seen</code>.
     */
    public final TableField<StatementsWithSortingRecord, LocalDateTime> LAST_SEEN = createField(DSL.name("last_seen"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.inline("0000-00-00 00:00:00.000000", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>sys.statements_with_sorting.digest</code>.
     */
    public final TableField<StatementsWithSortingRecord, String> DIGEST = createField(DSL.name("digest"), SQLDataType.VARCHAR(64), this, "");
    ...
    public <O extends Record> StatementsWithSorting(Table<O> child, ForeignKey<O, StatementsWithSortingRecord> key) {
