...
public class X$innodbLockWaitsRecord extends TableRecordImpl<X$innodbLockWaitsRecord> {
     ...
     */
    public void setWaitStarted(LocalDateTime value) {
        set(0, value);
    }
     ...
     */
    public LocalDateTime getWaitStarted() {
     ...
     */
    public void setWaitAge(LocalTime value) {
        set(1, value);
    }
    ...
    /**
     * Setter for <code>sys.x$innodb_lock_waits.locked_table_schema</code>.
     */
    ...
    /**
     * Getter for <code>sys.x$innodb_lock_waits.locked_table_schema</code>.
     */
    ...
    /**
     * Setter for <code>sys.x$innodb_lock_waits.locked_table_name</code>.
     */
    ...
    /**
     * Getter for <code>sys.x$innodb_lock_waits.locked_table_name</code>.
     */
    ...
    /**
     * Setter for <code>sys.x$innodb_lock_waits.locked_table_partition</code>.
     */
    ...
    /**
     * Getter for <code>sys.x$innodb_lock_waits.locked_table_partition</code>.
     */
    ...
    /**
     * Setter for <code>sys.x$innodb_lock_waits.locked_table_subpartition</code>.
     */
    ...
    /**
     * Getter for <code>sys.x$innodb_lock_waits.locked_table_subpartition</code>.
     */
     ...
     */
    public void setWaitingTrxStarted(LocalDateTime value) {
        set(11, value);
    }
     ...
     */
    public LocalDateTime getWaitingTrxStarted() {
     ...
     */
    public void setWaitingTrxAge(LocalTime value) {
        set(12, value);
    }
     ...
     */
    public LocalTime getWaitingTrxAge() {
     ...
     */
    public void setBlockingTrxStarted(LocalDateTime value) {
        set(24, value);
    }
     ...
     */
    public LocalDateTime getBlockingTrxStarted() {
     ...
     */
    public void setBlockingTrxAge(LocalTime value) {
        set(25, value);
    }
     ...
     */
    public LocalTime getBlockingTrxAge() {
        return (LocalTime) get(25);
    }
     ...
     */
    public X$innodbLockWaitsRecord(LocalDateTime waitStarted, LocalTime waitAge, Long waitAgeSecs, String lockedTable, String lockedTableSchema, String lockedTableName, String lockedTablePartition, String lockedTableSubpartition, String lockedIndex, String lockedType, ULong waitingTrxId, LocalDateTime waitingTrxStarted, LocalTime waitingTrxAge, ULong waitingTrxRowsLocked, ULong waitingTrxRowsModified, ULong waitingPid, String waitingQuery, String waitingLockId, String waitingLockMode, ULong blockingTrxId, ULong blockingPid, String blockingQuery, String blockingLockId, String blockingLockMode, LocalDateTime blockingTrxStarted, LocalTime blockingTrxAge, ULong blockingTrxRowsLocked, ULong blockingTrxRowsModified, String sqlKillBlockingQuery, String sqlKillBlockingConnection) {
        super(X$innodbLockWaits.X$INNODB_LOCK_WAITS);

        setWaitStarted(waitStarted);
        setWaitAge(waitAge);
        setWaitAgeSecs(waitAgeSecs);
        setLockedTable(lockedTable);
        setLockedTableSchema(lockedTableSchema);
        setLockedTableName(lockedTableName);
        setLockedTablePartition(lockedTablePartition);
        setLockedTableSubpartition(lockedTableSubpartition);
        setLockedIndex(lockedIndex);
        setLockedType(lockedType);
        setWaitingTrxId(waitingTrxId);
        setWaitingTrxStarted(waitingTrxStarted);
        setWaitingTrxAge(waitingTrxAge);
        setWaitingTrxRowsLocked(waitingTrxRowsLocked);
        setWaitingTrxRowsModified(waitingTrxRowsModified);
        setWaitingPid(waitingPid);
        setWaitingQuery(waitingQuery);
        setWaitingLockId(waitingLockId);
        setWaitingLockMode(waitingLockMode);
        setBlockingTrxId(blockingTrxId);
        setBlockingPid(blockingPid);
        setBlockingQuery(blockingQuery);
        setBlockingLockId(blockingLockId);
        setBlockingLockMode(blockingLockMode);
        setBlockingTrxStarted(blockingTrxStarted);
        setBlockingTrxAge(blockingTrxAge);
        setBlockingTrxRowsLocked(blockingTrxRowsLocked);
        setBlockingTrxRowsModified(blockingTrxRowsModified);
