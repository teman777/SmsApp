...
public class StatementPerformanceAnalyzer extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public static final Parameter<String> IN_ACTION = Internal.createParameter("in_action", SQLDataType.VARCHAR(12), false, false);

    /**
     * The parameter <code>sys.statement_performance_analyzer.in_table</code>.
     */
    public static final Parameter<String> IN_TABLE = Internal.createParameter("in_table", SQLDataType.VARCHAR(129), false, false);

    /**
     * The parameter <code>sys.statement_performance_analyzer.in_views</code>.
     */
    public static final Parameter<String> IN_VIEWS = Internal.createParameter("in_views", SQLDataType.VARCHAR(124), false, false);
