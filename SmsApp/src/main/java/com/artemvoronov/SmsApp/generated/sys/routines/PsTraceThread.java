...
public class PsTraceThread extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public static final Parameter<String> IN_OUTFILE = Internal.createParameter("in_outfile", SQLDataType.VARCHAR(255), false, false);

    /**
     * The parameter <code>sys.ps_trace_thread.in_max_runtime</code>.
     */
    public static final Parameter<BigDecimal> IN_MAX_RUNTIME = Internal.createParameter("in_max_runtime", SQLDataType.DECIMAL(20, 2), false, false);

    /**
     * The parameter <code>sys.ps_trace_thread.in_interval</code>.
     */
    public static final Parameter<BigDecimal> IN_INTERVAL = Internal.createParameter("in_interval", SQLDataType.DECIMAL(20, 2), false, false);

    /**
     * The parameter <code>sys.ps_trace_thread.in_start_fresh</code>.
     */
    public static final Parameter<Byte> IN_START_FRESH = Internal.createParameter("in_start_fresh", SQLDataType.TINYINT, false, false);

    /**
     * The parameter <code>sys.ps_trace_thread.in_auto_setup</code>.
     */
    public static final Parameter<Byte> IN_AUTO_SETUP = Internal.createParameter("in_auto_setup", SQLDataType.TINYINT, false, false);

    /**
     * The parameter <code>sys.ps_trace_thread.in_debug</code>.
     */
    public static final Parameter<Byte> IN_DEBUG = Internal.createParameter("in_debug", SQLDataType.TINYINT, false, false);
