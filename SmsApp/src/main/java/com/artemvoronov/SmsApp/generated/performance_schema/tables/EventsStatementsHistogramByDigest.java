...
public class EventsStatementsHistogramByDigest extends TableImpl<EventsStatementsHistogramByDigestRecord> {
     ...
     */
    public final TableField<EventsStatementsHistogramByDigestRecord, String> SCHEMA_NAME = createField(DSL.name("SCHEMA_NAME"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.events_statements_histogram_by_digest.DIGEST</code>.
     */
    public final TableField<EventsStatementsHistogramByDigestRecord, String> DIGEST = createField(DSL.name("DIGEST"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.events_statements_histogram_by_digest.BUCKET_NUMBER</code>.
     */
    public final TableField<EventsStatementsHistogramByDigestRecord, UInteger> BUCKET_NUMBER = createField(DSL.name("BUCKET_NUMBER"), SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.events_statements_histogram_by_digest.BUCKET_TIMER_LOW</code>.
     */
    public final TableField<EventsStatementsHistogramByDigestRecord, ULong> BUCKET_TIMER_LOW = createField(DSL.name("BUCKET_TIMER_LOW"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.events_statements_histogram_by_digest.BUCKET_TIMER_HIGH</code>.
     */
    public final TableField<EventsStatementsHistogramByDigestRecord, ULong> BUCKET_TIMER_HIGH = createField(DSL.name("BUCKET_TIMER_HIGH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.events_statements_histogram_by_digest.COUNT_BUCKET</code>.
     */
    public final TableField<EventsStatementsHistogramByDigestRecord, ULong> COUNT_BUCKET = createField(DSL.name("COUNT_BUCKET"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.events_statements_histogram_by_digest.COUNT_BUCKET_AND_LOWER</code>.
     */
    public final TableField<EventsStatementsHistogramByDigestRecord, ULong> COUNT_BUCKET_AND_LOWER = createField(DSL.name("COUNT_BUCKET_AND_LOWER"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.events_statements_histogram_by_digest.BUCKET_QUANTILE</code>.
     */
    public final TableField<EventsStatementsHistogramByDigestRecord, Double> BUCKET_QUANTILE = createField(DSL.name("BUCKET_QUANTILE"), SQLDataType.DOUBLE.nullable(false), this, "");
    ...
    public <O extends Record> EventsStatementsHistogramByDigest(Table<O> child, ForeignKey<O, EventsStatementsHistogramByDigestRecord> key) {
        super(child, key, EVENTS_STATEMENTS_HISTOGRAM_BY_DIGEST);
    }
